        ...
        <div
            ...
            <div className={classes['drop-down-menu__content']}>
                <nav className={classes['drop-down-menu__nav']}>
                    ...
                    <li className={classes.nav__item}>
                        <Link to='/' className={classes['drop-down-menu__link']} onClick={() => {
            ...
            <div
                className={!menuOpen ? classes['drop-down-menu__footer'] : `${classes['drop-down-menu__footer']} ${classes['menu-open']}`}>
                <FooterIcon/>
            </div>
        </div>
    );
